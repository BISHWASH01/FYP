...
$userID = getUserID($token);
    ...
    $resiPropertyList = getUserResidentialList($userID);
    $commercialPropertyList = getUserCommercialList($userID);
    $industrialPropertyList = getUserIndustrialList($userID);
    $landPropertyList = getUserLandList($userID);
...
function getUserResidentialList($userID){
    global $CON;
...
function getUserCommercialList($userID){
    global $CON;
    // $sql = "select * from product p  join category c on p.category = c.catID where p.userID = '$userID'";
    $sql = "SELECT p.propertyID,p.propertyName,p.propertyType, p.propertyDescription, p.price, p.isInStock, p.imageURL, p.userID, p.isVerified, 
    c.categoryID,c.categoryname, 
...
function getUserIndustrialList($userID){
    global $CON;
    // $sql = "select * from product p  join category c on p.category = c.catID where p.userID = '$userID'";
    $sql = "SELECT p.propertyID,p.propertyName,p.propertyType, p.propertyDescription, p.price, p.isInStock, p.imageURL, p.userID, p.isVerified, 
    c.categoryID,c.categoryname, 
...
function getUserLandList($userID){
    global $CON;
    // $sql = "select * from product p  join category c on p.category = c.catID where p.userID = '$userID'";
    $sql = "SELECT p.propertyID,p.propertyName,p.propertyType, p.propertyDescription, p.price, p.isInStock, p.imageURL, p.userID, p.isVerified, 
    c.categoryID,c.categoryname, 
