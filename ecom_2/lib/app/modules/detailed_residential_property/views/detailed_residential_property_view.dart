...
class DetailedResidentialPropertyView
    extends GetView<DetailedResidentialPropertyController> {
  const DetailedResidentialPropertyView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    var property = Get.arguments as Residential;
    ...
    return Scaffold(
      ...
      body: GetBuilder<DetailedResidentialPropertyController>(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Parking Space: ${property.parkingSpaces}',
                              style: TextStyle(fontSize: 15),
                            ),
                            Text(
  ...
  void _showReviewDialog(BuildContext context, Residential property) {
    showDialog(
      context: context,
