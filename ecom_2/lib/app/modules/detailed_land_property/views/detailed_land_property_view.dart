...
class DetailedLandPropertyView extends GetView<DetailedLandPropertyController> {
  const DetailedLandPropertyView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    var property = Get.arguments as Land;
    ...
    return Scaffold(
      ...
      body: GetBuilder<DetailedLandPropertyController>(
  ...
  void _showReviewDialog(BuildContext context, Land property) {
    showDialog(
      context: context,
