...
class DetailedIndustrialPropertyView
    extends GetView<DetailedIndustrialPropertyController> {
  const DetailedIndustrialPropertyView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('DetailedIndustrialPropertyView'),
        centerTitle: true,
        actions: [
      ...
      body: GetBuilder<DetailedIndustrialPropertyController>(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Clear height : ${property.clearHeight}',
                              style: TextStyle(fontSize: 15),
                            ),
                            Text(
                              'Power Supply: ${property.powerSupply}',
                              style: TextStyle(fontSize: 15),
                            ),
                            Text(
                              'Listing Type: ${property.propertyType}',
                              style: TextStyle(fontSize: 15),
                            ),
                          ],
                        ),
  ...
  void _showReviewDialog(BuildContext context, Industrial property) {
    showDialog(
      context: context,
