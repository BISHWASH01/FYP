...
abstract class Routes {
  ...
  static const USER_FAVOURITES = _Paths.USER_FAVOURITES;
  static const USER_PROPERTY_LISTING = _Paths.USER_PROPERTY_LISTING;
  static const USER_DETAIL_PROPERTY = _Paths.USER_DETAIL_PROPERTY;
  static const USER_ADD_PROPERTY = _Paths.USER_ADD_PROPERTY;
...
abstract class _Paths {
  ...
  static const USER_FAVOURITES = '/user-favourites';
  static const USER_PROPERTY_LISTING = '/user-property-listing';
  static const USER_DETAIL_PROPERTY = '/user-detail-property';
  static const USER_ADD_PROPERTY = '/user-add-property';
